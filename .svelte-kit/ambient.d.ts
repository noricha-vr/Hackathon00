...
declare module '$env/static/private' {
	...
	export const VSCEXT_EXHORT_SNYK_TOKEN: string;
	...
	export const VSCEXT_TRIGGER_REDHAT_REPOSITORY_RECOMMENDATION_NOTIFICATION: string;
	export const VSCEXT_TRIGGER_FULL_STACK_ANALYSIS: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_execpath: string;
		VSCEXT_EXHORT_SNYK_TOKEN: string;
		PATH: string;
		...
		npm_command: string;
		PWD: string;
		VSCEXT_TRIGGER_REDHAT_REPOSITORY_RECOMMENDATION_NOTIFICATION: string;
		VSCEXT_TRIGGER_FULL_STACK_ANALYSIS: string;
